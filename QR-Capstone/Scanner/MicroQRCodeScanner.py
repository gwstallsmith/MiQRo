...
def do_stuff(args):
    imgpath = args.image
    scannerPath = args.jar
    AIpath = args.upscaler
  ...
  #  AIpath = askopenfilename()
    ...
    create_svg(oldData, outputPath, imgpath)
...
if __name__ == "__main__" :
    ...
    parser.add_argument("--jar", help="applications.jar file path", default="./java/applications.jar")
    parser.add_argument("--upscaler", help="AI upscaler model file path", default="./upscaleModels/ESPCN_x2.pb")
