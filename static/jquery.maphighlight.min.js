    ...
    c || l) {
        if (c) {
            ...
            f = function(t) {
                ...
                return i.getContext("2d").clearRect(0, 0, d(t).width(), d(t).height()),
                i
            }
            ;
            function b(t, e, a, o, r) {
                ...
                "rect" == e)
                    ...
                    for (t.moveTo(a[0] + o, a[1] + r),
                    i = 2; i < a.length; i += 2)
                        t.lineTo(a[i] + o, a[i + 1] + r);
                else
                    "circ" == e && t.arc(a[0] + o, a[1] + r, a[2], 0, 2 * Math.PI, !1);
                t.closePath()
            }
            p = function(t, i, e, a, o) {
                ...
                if (a.shadow) {
                    r.save(),
                    "inside" == a.shadowPosition && (b(r, i, e),
                    r.clip());
                    var s = 100 * t.width
                      , n = 100 * t.height;
                    b(r, i, e, s, n),
                    ...
                    "stroke" == h ? (r.strokeStyle = "rgba(0,0,0,1)",
                    r.stroke()) : "fill" == h && (r.fillStyle = "rgba(0,0,0,1)",
                    r.fill()),
                    r.restore(),
                    "outside" == a.shadowPosition && (r.save(),
                    b(r, i, e),
                ...
                r.save(),
                b(r, i, e),
                a.fill && (r.fillStyle = v(a.fillColor, a.fillOpacity),
                r.fill()),
                a.stroke && (r.strokeStyle = v(a.strokeColor, a.strokeOpacity),
                r.lineWidth = a.strokeWidth,
                r.stroke()),
                r.restore(),
                a.fade && d(t).css("opacity", 0).animate({
                    opacity: 1
                }, 100)
            }
            ,
        ...
        g = function(t) {
            ...
            if ("defa" !== a) {
                for (e = (t.getAttribute("coords") || "").split(","),
                i = 0; i < e.length; i++)
                    e[i] = parseFloat(e[i]);
                return [a, e]
            }
        ...
        d.fn.maphilight = function(h) {
            return h = d.extend({}, d.fn.maphilight.defaults, h),
            c || t || (d(window).ready(function() {
            ...
            this.each(function() {
                ...
                if (r = d.extend({}, h, !!d.metadata && e.metadata(), e.data("maphilight")),
                (i = e.get(0).getAttribute("usemap")) && (s = d('map[name="' + i.substr(1) + '"]'),
